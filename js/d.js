...
function Dot() {
  this.colors = [15132390, 9868950, 5658198];
  this.blinkColors = [16737843, 2293606, 3368703];
...
function Diamond(e, t) {
  ...
  this.textureButton = PIXI.Texture.fromImage(base_url + "/assets/rollover2.png");
  this.textureButton2 = PIXI.Texture.fromImage(base_url + "/assets/rollover1.png");
  ...
  var n;
  var r = Math.PI * .2;
  var i = Math.PI * 2 / _CONF_.data_point;
  var s;
  var o;
  var u;
  var a;
  ...
  if (!PBISite.blockDiamond) {
    ...
    if (PBISite.selectedTemplate == PBISite.HOME_PAGE) {
      ...
      TweenLite.to(PBISite.dotsLayer.view, 6, {alpha: 1, ease: Sine.easeOut, overwrite: "all", delay: 1});
      ...
      TweenLite.to(PBISite.dotsLayer.view, 1.5, {alpha: .1, ease: Power1.easeOut, overwrite: "all"});
...
function Timer(e, t) {
  var n = time = (new Date(e || null)).valueOf(), t = t || 10;
...
var Delaunay = new function () {
  ...
  this.sortOn = function (e) {
    return function (t, n) {
      if (t[e] < n[e])return -1; else if (t[e] > n[e])return 1; else return 0
    }
  };
  this.triangulate = function (e) {
    ...
    for (_ = 0; _ < n; _++) {
      ...
      var q;
      var R;
      for (P = 0; P < i - 1; P++)for (var U = P + 1; U < i; U++) {
    ...
    for (_ = 0; _ < A; _++)if (t[_].p1 >= n || t[_].p2 >= n || t[_].p3 >= n) {
      t[_] = t[A - 1];
      A--;
      _--
    }
...
Diamond.prototype.animateDiamond = function () {
  ...
  PBISite.diamondContainer.rotation += _CONF_.rotate_deg;
};
