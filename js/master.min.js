...
function reflovDiamond() {
  if (PBISite.renderer) {
    ...
    PBISite.renderer.resize(PBISite.browser_width, PBISite.browser_height),
      ...
      PBISite.renderer.view.style.height = PBISite.browser_height + "px", PBISite.renderer.view.width = PBISite.browser_width, PBISite.renderer.view.height = PBISite.browser_height, PBISite.dotsLayer.view.scale.x = PBISite.dotsLayer.view.scale.y = PBISite.scaleY, null != PBISite.bgTexture && (PBISite.bgTexture.scale.x = PBISite.browser_width / 1920, PBISite.bgTexture.scale.y = PBISite.browser_height / 1068), PBISite.deactivePoints || (PBISite.dotsContainer.scale.x = PBISite.dotsContainer.scale.y = PBISite.scaleY, PBISite.dotsContainer.x = PBISite.browser_width / 2 + marginLeftDiamond, PBISite.dotsContainer.y = PBISite.browser_height / 2), PBISite.blockDiamond ? (PBISite.diamondContainer.x = PBISite.browser_width / 2 + marginLeftDiamond, PBISite.diamondContainer.y = PBISite.browser_height / 2, PBISite.dotsLayer.view.x = -400 * PBISite.scaleY, PBISite.dotsLayer.view.y = -400 * PBISite.scaleY) : (PBISite.diamondContainer.x = PBISite.browser_width / 2 + marginLeftDiamond, PBISite.diamondContainer.y = PBISite.browser_height / 2)
  }
}
...
}, marginLeft = 400, marginLeftDiamond = 50, marginRight = 300, marginInsLeft = 47, marginInsLeft2 = 44, footerHeight = 75, loader, soundLoop, loadMusic;
