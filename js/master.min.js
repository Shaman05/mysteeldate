...
function updateValues() {
  ...
  var b = document.getElementById("menuMobile"), c = document.getElementById("menuHolder"), d = document.getElementById("menuMobileShow"), e = document.getElementById("footerPBI"), f = document.getElementById("bgHider"), g = document.getElementById("dots2"), h = document.getElementById("dots");
...
function naviReflov() {
  var a = document.getElementById("logoPBI"), b = document.getElementById("logoTypo"), c = document.getElementById("logoTypo2"), d = document.getElementById("menuRight"), e = document.getElementById("menuTop"), f = document.getElementById("bgHider"), h = 1;
  ...
  var r = document.getElementById("menuMobile"), s = document.getElementById("menuMobileShow"), t = document.getElementById("instytutItemOutM"), u = document.getElementById("ofertaItemOutM"), v = document.getElementById("ofertaItemOut2M"), w = document.getElementById("inicjatywyItemOutM"), x = document.getElementById("wydarzeniaItemOutM"), y = document.getElementById("zalozycielkaItemOutM"), z = document.getElementById("kontaktItemOutM"), A = PBISite.browser_width / PBISite.browser_height;
  ...
  var C = document.getElementById("mainQuoteAll"), D = document.getElementById("mainQuoteHidden"), E = document.getElementById("lineQuote1"), F = document.getElementById("lineQuote2");
...
$(function () {
  PBISite.scrollElement2 = document.getElementById("menuMobile"), PBISite.selectedTemplate = selectedTemplate, PBISite.selectedTemplate == PBISite.CONTACT_TMP && setUpKontakt(), PBISite.selectedTemplate == PBISite.PUBLICTEXT_TMP && setUpPublikacje(), PBISite.selectedTemplate == PBISite.NEWS_TMP && setUpNews(), setUpSiteLinks(), setMenu(), loadSounds(), TweenLite.to("#arrowD", 0, {autoAlpha: 0}), window.addEventListener && (window.addEventListener("resize", updateValues, !1), window.addEventListener("DOMContentLoaded", updateValues, !1), window.addEventListener("load", updateValues, !1), DetectIt.isMobile ? window.addEventListener("touchmove", touchMove, !1) : window.addEventListener("mousemove", mouseMove, !1)), ffArrow();
